...
class NeuralCDE(torch.nn.Module):
    def __init__(self, vector_field, input_channels, hidden_channels, output_channels):
...
def main(args):
    ...
    vector_field = VectorField(input_channels, hidden_channels, hidden_hidden_channels, num_hidden_layers)
    model = NeuralCDE(vector_field=vector_field, input_channels=input_channels, hidden_channels=hidden_channels, output_channels=output_channels).to(device)
